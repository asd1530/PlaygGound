...
namespace Common.Sie
{
    ...
    public class SieDocument
    {
        ...
        public bool IgnoreBTRANS = true;
        public bool IgnoreMissingOMFATTNING = true;
        public bool IgnoreRTRANS = true;
        /// <summary>
        ...
        public void ReadFileDocument(string fileName)
        {
        ...
        public void ReadStreamDocument(StreamReader reader)
        {
            ...
            FNAMN.FileImportId = this.fileId;
        ...
        private void parseKTYP(SieDataItem di)
        {
            ...
            KONTO[di.GetString(0)].AccountType = di.GetString(1);
        }
